...
const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      className="relative flex items-center h-9 w-14 rounded-full glass-panel border border-white/10 cursor-pointer overflow-hidden transition-all duration-500 ease-out"
    >
      <motion.div
